...
export type ConnectionState = { kind: "idle" | "preparing" | "validating_config" | "starting_core" | "waiting_for_proxy" | "proxy_ready" | "connected" | "stopping" | "crashed" | "error"; message?: string; socksPort?: number };
